    ...
    <div className="items-center font-mono text-white bg-indigo-500 mt-8">
      ...
      <div className="pt-6 pl-10 pb-6 text-xl font-bold">
        <div className="flex items-center gap-x-2">
          ...
          <ul className="">Tel : 0615325744</ul>
        </div>

        <div className="flex items-center gap-x-2">
          <img className="" src={gmail} />
          <ul className="">Email : tongs2004@gmail.com</ul>
        </div>
        ...
        <div className="flex items-center gap-x-2">
          ...
          <ul className="">Facebook : Supanut Wongtanom</ul>
        </div>
        ...
        <div className="flex items-center gap-x-2">
          ...
          <ul className="">Instagram : supernut_t</ul>
        </div>
        ...
        <div className="flex items-center gap-x-2">
          ...
          <ul className="">Github : tong788</ul>
        </div>
      </div>
    </div>
  );
